...
def download_data(endpoint, dir_name):
    # Select the preferred transport
    transport = AIOHTTPTransport(url=endpoint, headers=SAMPLE_HEADERS)
    ...
    offset = 0
    while True:
        filename = dir_name + '/post_scraping_sort-by-old_offset-{}_limit-{}.json'.format(offset, LIMIT)
...
if __name__ == "__main__":
    download_data(LESSWRONG_ENDPOINT, 'data/lesswrong_NEW')